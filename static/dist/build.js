...
var _vueJsModal = __webpack_require__(6);
...
var nutritionApp = new _vue2.default({
    el: '#nutritionApp',
    data: {
        // search results
        foods: [],
    ...
    methods: {
        ...
        nutrientsHaveId: function nutrientsHaveId(id) {
        ...
        nutrientById: function nutrientById(id) {
            // console.log(id)
            for (var i = this.nutrients.length - 1; i >= 0; i--) {
        ...
        unselectFood: function unselectFood(food) {
        ...
        fetchFoodData: function fetchFoodData(fetch) {
            // retrieves the search results for the user
            console.log('This: ', this);
            this.$http.get('http://127.0.0.1:3000/search?search_term=' + fetch).then(function (response) {
                nutritionApp.foods = response.body.list.item;
            }, function (response) {});
        },
        addNutrientsToItem: function addNutrientsToItem(item, nutrients) {
            item.nutrients = {};
        ...
        selectFood: function selectFood(item) {
            var _this = this;
            ...
            this.$http.get('http://127.0.0.1:3000/item?ndbno=' + item.ndbno).then(function (response) {

                var someData = response.body;
                var nutrients = someData.report.food.nutrients;

                item = _this.addNutrientsToItem(item, nutrients);
        ...
        processFood: function processFood(item) {
            var _this2 = this;
        ...
        tallyNutrientsForSelection: function tallyNutrientsForSelection(food) {
            for (var i = this.nutrients.length - 1; i >= 0; i--) {
        ...
        lowNutrients: function lowNutrients() {
            for (var i = this.nutrients.length - 1; i >= 0; i--) {
        ...
        getItem: function getItem(ndbno, i, nid) {
        ...
        recommendFood: function recommendFood() {
